...
def build_payment_text(order_number, product_name, quantity_text, price, target_value, target_type):
    lines = [
        f'<tg-emoji emoji-id="5404617696589390973">✅</tg-emoji> <b>ЗАКАЗ №{order_number} СОЗДАН!</b>',
        '',
    ...
    lines.extend([
        f'• Сумма: {fmt_price(price)} ₽',
        '',
        '<tg-emoji emoji-id="5445353829304387411">💳</tg-emoji> <b>РЕКВИЗИТЫ ДЛЯ ОПЛАТЫ:</b>',
        '',
        '<tg-emoji emoji-id="5201863929906620821">🏦</tg-emoji> СБЕР',
        '<tg-emoji emoji-id="5287761106868140153">💳</tg-emoji> Карта: <code>2202 2084 1737 7224</code>',
        '<tg-emoji emoji-id="5458789419014182183">👤</tg-emoji> Получатель: Дмитрий',
        '',
        '<tg-emoji emoji-id="5201870565631093696">🏦</tg-emoji> ВТБ',
        '<tg-emoji emoji-id="5287761106868140153">💳</tg-emoji> Карта: <code>2200 2479 5387 8262</code>',
        '<tg-emoji emoji-id="5458789419014182183">👤</tg-emoji> Получатель: Дмитрий',
        '',
